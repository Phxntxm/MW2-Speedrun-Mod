...
scene_gun_monologue_dialogue( start_time_offset )
{
	...
	wait_for_buffer_time_to_pass( start_time, 0.0 );
	...
	wait_for_buffer_time_to_pass( start_time, 4.6 + extra_wait );
	...
	wait_for_buffer_time_to_pass( start_time, 14.3 + extra_wait );
