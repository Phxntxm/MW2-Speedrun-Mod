...
market_evac_dialogue()
{
	...
	// " ETA 20 seconds! Be ready for immediate dustoff!"
	...
	thread door_kick_housespawn( door3, kickRef3 );
...
market_evac_enemies()
{
	...
	*/
	...
	delaythread( 0.5, ::market_evac_housespawners );
...
market_evac_housespawners()
{
	...
	delaythread( 4, ::door_kick_housespawn, door1_spawners, door1, kickRef1 );
...
roofrun_player_recovery( player_rig, groundref )
{
	...
	level.player FreezeControls( true );
	wait( 1 );
	black_overlay FadeOverTime( 1.5 );
	black_overlay.alpha = 0;
	fadeouttp = ( -6265, -868, 784 );
	level.player TakeAllWeapons();
	level.player SetOrigin( fadeouttp );
