...
player_velocity_setup( start_flag, passed_flag, message )
{
	...
	xpos = -72;
	self.hud_velocity_msg = maps\_specialops::so_create_hud_item( -2, xpos, message, self );

	self.hud_velocity_value = maps\_specialops::so_create_hud_item( -2, xpos, vel, self );
...
enable_difficulty_tracker_setup( start_flag, passed_flag, message )
{
	...
	xpos = -72;
	self.hud_difficulty_msg = maps\_specialops::so_create_hud_item( -3, xpos, message, self );

	self.hud_difficulty_value = maps\_specialops::so_create_hud_item( -3, xpos, diffi, self );
...
enable_name_tracker_setup( start_flag, passed_flag, message )
{
	...
	xpos = -72;
	self.hud_playername_msg = maps\_specialops::so_create_hud_item( -5, xpos, message, self );

	self.hud_playername_value = maps\_specialops::so_create_hud_item( -5, xpos, name, self );
...
enable_twitch_tracker_setup( start_flag, passed_flag, message )
{
	...
	xpos = -72;
	self.hud_twitchname_msg = maps\_specialops::so_create_hud_item( -4, xpos, message, self );

	self.hud_twitchname_value = maps\_specialops::so_create_hud_item( -4, xpos, tv, self );
