...
main()
{
	...
	level.timeEasy = 3;		//anything above this number will choose "easy"
	level.timeRegular = 2;		//anything above this number but less than timeEast will choose "regular"
	level.timeHard = 1;		//anything above this number but less than timeRegular will choose "hard"
...
firing_range_hip_and_ads()
{
	...
	//Sgt. Foley  That's all there is to it. You want your target to go down? You gotta .	
...
firing_range_penetration()
{
	...
	delaythread( 0.02,:: lowerPlywoodWalls );
...
AA_find_the_pit_sequence()
{
	...
	delaythread ( 0.02, ::objective_hints, "obj_go_to_the_pit_done" );
...
dialogue_course_civilian_killed()
{
	...
	dialogue = [];
	dialogue[ 0 ] = ""; //Cpl. Dunn		Watch out for civilians.	
	dialogue[ 1 ] = ""; //Cpl. Dunn		Aww you killed a civvie. Come on, Allen!	
	dialogue[ 2 ] = "";	//Cpl. Dunn		That was a civilian, Private.	
	iLine = 0;
