...
handler_crash_to_roof()
{
	...
	foleytp = ( 1165, -4572, 2364 );
	dunntp = ( 1080, -5531, 2363 );
	level.raptor forceTeleport( foleytp );
	level.taco forceTeleport( dunntp );
